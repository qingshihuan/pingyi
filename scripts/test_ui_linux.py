...
class LinuxUiContracts(unittest.TestCase):
    ...
    def test_selection_wait_is_not_pixel_read_timeout(self):
        source = (ROOT / 'src/PingYi.App/CaptureSelectionRouter.cs').read_text(encoding='utf-8-sig')
    ...
    def test_wayland_does_not_attempt_to_capture_xwayland_root(self):
        source = (ROOT / 'src/PingYi.Infrastructure/ScreenCaptureServices.cs').read_text(encoding='utf-8-sig')
